...
import { FiSquare, FiUsers, FiUser, FiHeart } from "react-icons/fi";
...
const RoomSaved = ({ room }) => {
  return (
    <div className="rounded-lg custome-shadow p-4">
      ...
      <Link
        to={`/rooms/${room._id}`}
        className="bg-blue/80 w-full rounded-md text-white flex justify-center items-center custome-shadow-sm py-2 mt-5 hover:text-white"
      >
        See Details
      </Link>
    </div>
